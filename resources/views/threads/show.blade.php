        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="level">
                                ...
                                @if(Auth::check() && $thread->thread_status_id == 2 || $thread->thread_status_id == 3)
                                    <!-- UpVote -->
                                    <form action="{{$thread->path()}}/votes" method="POST">
                                        ...
                                        <div class="form-group">
                                            <button type="submit"
                                                class="btn  {{$isUpVotedOn ? 'btn-success' :'btn-default' }} glyphicon glyphicon-thumbs-up">
                                                {{ $thread->upvotesCount }}
                                            </button> &nbsp;
                                        </div>
                                    </form>
                                    ...
                                    <form action="{{$thread->path()}}/votes" method="POST">
                                        ...
                                        <div class="form-group">
                                        <!-- Button Form Input  -->
                                            <button type="submit" class="btn  {{$isDownVotedOn ? 'btn-danger' :'btn-default' }} glyphicon glyphicon-thumbs-down">
                    ...
                    <!-- Odgovor organa -->
                    @if($thread->thread_status_id == 5 || $thread->thread_status_id == 6)
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <p>
                                ...
                                <br>
                                število glasov: {{ $thread->upvotesCount + $thread->downvotesCount }}
                            </p>
                            ...
                            <div>
                                ...
                                <div class="fb-like"
                                     data-href="http://localhost/learn-vue/tab/test.html#"
                                     data-send="false"
